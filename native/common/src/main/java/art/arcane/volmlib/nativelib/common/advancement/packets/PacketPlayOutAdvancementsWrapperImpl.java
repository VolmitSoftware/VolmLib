...
public class PacketPlayOutAdvancementsWrapperImpl extends PacketPlayOutAdvancementsWrapper {
    ...
    public PacketPlayOutAdvancementsWrapperImpl() {
        this.packet = createPacket(true, Collections.emptyList(), Collections.emptySet(), Collections.emptyMap());
    }

    public PacketPlayOutAdvancementsWrapperImpl(@NotNull Map<AdvancementWrapper, Integer> toSend) {
    ...
    public PacketPlayOutAdvancementsWrapperImpl(@NotNull Set<MinecraftKeyWrapper> toRemove) {
    ...
    public static ClientboundUpdateAdvancementsPacket removalPacket(Set<Identifier> removals) {
        try {
            return (ClientboundUpdateAdvancementsPacket) PACKET_CONSTRUCTOR.invoke(false,
                    Collections.emptyList(), removals, Collections.emptyMap(), false);
        } catch (Throwable error) {
            throw new IllegalStateException("Unable to create the advancement removal packet.", error);
        }
    }
