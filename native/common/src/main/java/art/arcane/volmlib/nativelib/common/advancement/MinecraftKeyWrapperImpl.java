...
public class MinecraftKeyWrapperImpl extends MinecraftKeyWrapper {
    private final Identifier key;

    public MinecraftKeyWrapperImpl(@NotNull Object key) {
        this.key = (Identifier) key;
    }

    public MinecraftKeyWrapperImpl(@NotNull String namespace, @NotNull String key) {
        try {
