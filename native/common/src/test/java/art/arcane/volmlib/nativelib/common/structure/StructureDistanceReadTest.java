 ...
 */
public class StructureDistanceReadTest {
    ...
    public void readsPlainIntField() throws Exception {
        assertEquals(80, StructureReflection.readIntMember(new IntShape(), "maxDistanceFromCenter"));
    }

    @Test
    public void readsLargestIntComponentFromWrapperRecord() throws Exception {
        assertEquals(96, StructureReflection.readIntMember(new WrapperShape(), "maxDistanceFromCenter"));
    }

    @Test
    public void readsBoxedNumberField() throws Exception {
        assertEquals(64, StructureReflection.readIntMember(new BoxedShape(), "maxDistanceFromCenter"));
    }
}
