...
public class RuntimeResolutionTest {
    ...
    public void resolvesExactCreateLevelMethod() throws Exception {
        Method method = RuntimeResolution.resolveCreateLevelMethod(CurrentCreateLevelOwner.class);
    ...
    public void resolvesDeclaredLegacyCreateLevelMethod() throws Exception {
        Method method = RuntimeResolution.resolveCreateLevelMethod(DeclaredLegacyCreateLevelOwner.class);
    ...
    public void resolvesTwoArgLevelStorageAccessMethod() throws Exception {
        Method method = RuntimeResolution.resolveLevelStorageAccessMethod(TwoArgLevelStorageSource.class);
    ...
    public void resolvesOneArgLevelStorageAccessMethod() throws Exception {
        Method method = RuntimeResolution.resolveLevelStorageAccessMethod(OneArgLevelStorageSource.class);
    ...
    public void resolvesPublicWorldDataHelper() throws Exception {
        Method method = RuntimeResolution.resolvePaperWorldDataMethod(PublicWorldLoader.class);
    ...
    public void resolvesDeclaredWorldDataHelper() throws Exception {
        Method method = RuntimeResolution.resolvePaperWorldDataMethod(DeclaredWorldLoader.class);
    ...
    public void resolvesDeclaredServerRegistryAccessMethod() throws Exception {
        Method method = RuntimeResolution.resolveServerRegistryAccessMethod(DeclaredRegistryAccessOwner.class);
    ...
    public void resolvesCurrentWorldLoadingInfoConstructor() throws Exception {
        Constructor<?> constructor = RuntimeResolution.resolveWorldLoadingInfoConstructor(CurrentWorldLoadingInfo.class);
    ...
    public void resolvesLegacyWorldLoadingInfoConstructor() throws Exception {
        Constructor<?> constructor = RuntimeResolution.resolveWorldLoadingInfoConstructor(LegacyWorldLoadingInfo.class);
