...
public final class NativeStructurePoiUpdates {
    ...
    public NativeStructurePoiUpdates(int skipPoiFlag) {
        this.skipPoiFlag = skipPoiFlag;
    }

    public static NativeStructurePoiUpdates create() {
        try {
    ...
    public boolean setBlock(WorldGenLevel world, BlockPos position, BlockState state, int flags, int limit) {
    ...
    public static void reconcile(LevelChunk chunk) {
