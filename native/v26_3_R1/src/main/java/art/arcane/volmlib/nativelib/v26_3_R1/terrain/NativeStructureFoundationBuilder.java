...
public final class NativeStructureFoundationBuilder {
    ...
    public static void placeStilts(WorldGenLevel world, BoundingBox area, String structureId,
                            StructureStart start, StructureStiltSettings settings,
    ...
    public static boolean isStiltColumn(int x, int z, int spacing) {
    ...
    public static int findStiltAnchorY(
