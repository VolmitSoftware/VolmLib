...
import art.arcane.volmlib.nativelib.v26_3_R1.terrain.NativeBukkitStructureStage;
...
import art.arcane.volmlib.nativelib.v26_3_R1.terrain.NativeImportedFeatureStage;
...
import art.arcane.volmlib.nativelib.v26_3_R1.terrain.InitialMobSpawner;
...
import art.arcane.volmlib.nativelib.v26_3_R1.terrain.NativeStructureVanillaLocator;
...
public class NativeChunkGenerator<C, D, P extends StructureStartPlan, O extends StructureOwnershipRecordView<O>, R extends NativeGenerationRoute> extends CustomChunkGenerator implements LongPredicate {
    ...
    public CompletableFuture<ChunkAccess> buildTerrain(ChunkAccess ichunkaccess, Blender blender, RandomState randomstate, StructureManager structuremanager, BiomeManager biomeManager, WorldGenRegion carverBiomeRegion, Set<Holder<Biome>> possibleBiomes) {
        return terrainPipeline.buildTerrain(ichunkaccess, blender, randomstate, structuremanager, biomeManager, carverBiomeRegion, possibleBiomes);
    }
