...
public final class NativeBiomeSourceImpl extends BiomeSource implements StructureBiomeSource, BiomeResolver {
    ...
    public Pair<BlockPos, Holder<Biome>> findBiomeHorizontal(int x, int y, int z, int radius,
            Predicate<Holder<Biome>> allowed, RandomSource random, RandomState sampler) {
    ...
    public Pair<BlockPos, Holder<Biome>> findClosestBiome3d(BlockPos origin, int radius,
            ...
            RandomState sampler, LevelReader level) {
