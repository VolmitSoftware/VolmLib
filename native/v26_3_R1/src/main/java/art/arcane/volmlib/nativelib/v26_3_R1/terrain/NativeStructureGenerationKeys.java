...
public final class NativeStructureGenerationKeys {
    ...
    public static boolean hasPossibleBiome(Structure structure, Set<String> possibleBiomeKeys) {
    ...
    public static boolean isEnabledPlacement(StructurePlacement placement) {
