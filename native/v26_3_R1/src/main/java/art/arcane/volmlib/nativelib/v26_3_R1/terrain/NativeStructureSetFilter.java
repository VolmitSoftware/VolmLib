...
public final class NativeStructureSetFilter {
    private NativeStructureSetFilter() {
    }

    public static Selection filter(
            List<Holder<StructureSet>> structureSets,
            StructureScope scopeIndex,
            Set<String> declaredSources
    ) {
        return filter(structureSets, scopeIndex, declaredSources, StructureFrequencyControl.NONE);
    }
    ...
    public static String structureSetKey(Holder<StructureSet> holder) {
        return structureSetKey(holder, keyIndex(List.of(holder)));
    }

    public static StructureSetKeyIndex keyIndex(
    ...
    public static Optional<AbstractSpreadingStructurePlacement.ExclusionZone> exclusionZone(StructurePlacement placement) {
    ...
    public static final class StructureSetKeyIndex {
