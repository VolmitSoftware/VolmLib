...
public final class NativeStructureReflection {
    private NativeStructureReflection() {
    }

    public static Field resolveScatteredHeightPositionField() {
        Field resolved = null;
    ...
    public static RuinedPortalPiece.VerticalPlacement ruinedPortalVerticalPlacement(RuinedPortalPiece piece) {
        try {
    ...
    public static Field resolveSinglePoolTemplateField() {
        Field resolved = null;
    ...
    public static StructureTemplate resolveTemplate(SinglePoolElement element,
    ...
    public static List<StructureTemplate.StructureBlockInfo> resolveTemplateBlocks(
    ...
    public static StructurePlaceSettings resolvePlacementSettings(
    ...
    @SuppressWarnings("unchecked")
    public static List<StructureTemplate.StructureBlockInfo> processTemplateBlocks(
    ...
    public static StructureTemplate resolveTemplateReference(Either<?, ?> reference,
                                                       Supplier<StructureTemplateManager> templates) {
    ...
    public static final class MonumentChildPiecesAccess {
        public static final Field FIELD = resolveMonumentChildPiecesField();
    ...
    public static final class ScatteredHeightPositionAccess {
        public static final Field FIELD = resolveScatteredHeightPositionField();
