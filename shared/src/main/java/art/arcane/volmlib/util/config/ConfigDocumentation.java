...
public final class ConfigDocumentation {
    private static final Map<String, String> SUMMARY_BY_KEY = Map.ofEntries(
            ...
            Map.entry("blacklistedWorlds", "World folder names where this plugin's logic is disabled."),
            ...
            Map.entry("advancements", "Enables advancement registration and grant flow."),
            Map.entry("loginBonus", "Grants the configured login bonus message/rewards."),
            Map.entry("welcomeMessage", "Shows the welcome message when players join.")
    );
