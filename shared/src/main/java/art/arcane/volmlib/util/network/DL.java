...
public abstract class DL {
    ...
    protected static long transfer(InputStream in, OutputStream out, int targetBuffer, long totalSize) throws IOException {
    ...
    protected static long transfer(InputStream in, OutputStream out, byte[] buf, int totalSize) throws IOException {
        long total = totalSize;
        long wrote = 0;
        int r = 0;
    ...
    public static class ThrottledDownload extends Download {
        ...
        protected long download() throws IOException {
            ...
            return transfer(in, o, 8192, bufferSize);
        }
    }
    ...
    public static class Download extends DL {
        ...
        @Override
        protected long download() throws IOException {
            return transfer(in, o, buf, bufferSize);
        }
